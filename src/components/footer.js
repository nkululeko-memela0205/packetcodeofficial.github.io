      ...
      <div className="footer-max-width max-content-container">
        <div className="footer-banner">
          <h1 className="footer-text">
            Visit us on our social mEDIA and see goals + dribbles 
          </h1>
        </div>
        <div className="footer-bottom-container">
          <div className="footer-left-side">
            <img
              alt="image"
              src="/turfkings-1200w.png"
              className="footer-image"
            />
          </div>
          <div className="footer-left-side1">
            <span className="footer-text01">
              <span className="footer-text02">About us</span>
              <span className="">
                : We are a group of young professionals who play 5 asides soccer
                casually but are open to all sorts of profound group ideas.
              </span>
              <br className=""></br>
              <br className=""></br>
              <span className="footer-text06">Agenda</span>
              <span className="">: Football &amp; fitness</span>
              <br className=""></br>
              <br className=""></br>
              <span className="footer-text10">Sponsor us</span>
              <span className="">
                : Feel free to sponsor us if you&apos;re inspired.
              </span>
              <br className=""></br>
              <br className=""></br>
              <span className="footer-text14">Contact us</span>
              <span className=""> : nkululeko.memela0205@gmail.com</span>
              <br className=""></br>
            </span>
            <div className="footer-social-media">
              <span className="footer-text17">The Turf Kings 5s  </span>
        ...
        <div className="footer-copyright">
          <span className="footer-text18">
            ...
            <a
              ...
              className=""
            >
              <span className="footer-text22">@TeleportHQ.</span>
            </a>
            <span className="">
              <span className="">
                {' '}
            ...
            <a
              ...
              className=""
            >
              <span className="footer-text26">Vercel</span>
            </a>
            <span className="">
              <span className="">
                . Image source:
            ...
            <a
              ...
              className=""
            >
              <span className="footer-text30">Unsplash</span>
            </a>
            <span className="">.</span>
          </span>
        </div>
